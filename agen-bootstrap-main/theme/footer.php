    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-md-3 col-6">
          <h4 class="text-white mb-5">Acerca de</h4>
          <ul class="list-unstyled">
            <li><a href="#" class="text-light d-block mb-3">Servicio</a></li>
            <li><a href="#" class="text-light d-block mb-3">Contacto</a></li>
            <li><a href="#" class="text-light d-block mb-3">Sobre nosotros</a></li>
            <li><a href="#" class="text-light d-block mb-3">Blog</a></li>
            <li><a href="#" class="text-light d-block mb-3">Soporte</a></li>
          </ul>
        </div>
        <div class="col-md-3 col-6">
          <h4 class="text-white mb-5">Compañía</h4>
          <ul class="list-unstyled">
            <li><a href="#" class="text-light d-block mb-3">Servicio</a></li>
            <li><a href="#" class="text-light d-block mb-3">Contacto</a></li>
            <li><a href="#" class="text-light d-block mb-3">Sobre nosotros</a></li>
        ...
        <div class="col-md-6">
          <div class="bg-white p-4">
            ...
            <form action="#">
              ...
              <input type="text" id="email" name="email" class="form-control mb-4 px-0" placeholder="Correo electrónico">
    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-md-6 text-center text-md-left">
          <p class="text-light mb-0">Copyright &copy; 2019 un tema de <a class="text-gradient-primary" href="https://themefisher.com">themefisher.com</a>
          </p>
        </div>
        <div class="col-md-6">
