...
<body>
    <div class="container-fluid">
        ...
        <div class="container  text-white p-5">
            ...
            <form action="index.php" method="POST" class="fw-bold bg-dark p-4 rounded-2">
            <p class="text-center">Por favor llena este formulario para poder iniciar</p>
                ...
                <input type="number" name="numplayer" class="form-control" required max="5" min="2">
                <label for="" class="form-label m-3">Numero de cartas por jugador:</label>
                <input type="number" name="numcard" class="form-control" required max="6" min="1">
